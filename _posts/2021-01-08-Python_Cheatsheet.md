...
这是一个东欧小哥在 Github 上的开源项目  
很用心的做了个 Python 使用大全  
有喜欢的可以去作者的 Github 上点个星星  
土豪也可以去买他的 PDF 支持一下
...
![Covid Deaths](https://cdn.jsdelivr.net/gh/gto76/python-cheatsheet/web/covid_deaths.png)
...
![Covid Cases](https://cdn.jsdelivr.net/gh/gto76/python-cheatsheet/web/covid_cases.png)
